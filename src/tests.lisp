...
(format t "; Diassembling 'out.prg' to match against 'tests/all_instructions_disassembled.lst'…")
(disassemble-file "tests/all_instructions.bin" "all_instructions_diassembled.lst")
(= *model* :vic-20)
